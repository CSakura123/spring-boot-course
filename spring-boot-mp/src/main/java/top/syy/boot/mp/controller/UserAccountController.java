package top.syy.boot.mp.controller;
...
import top.syy.boot.mp.Service.UserAccountService;
import top.syy.boot.mp.common.ApiResponse;
import top.syy.boot.mp.entity.UserAccount;
...
public class UserAccountController {
    ...
    /** 分页查询用户账户 */
    @GetMapping("/page")
    public ApiResponse<IPage<UserAccount>> getUsersPage(@RequestParam(defaultValue = "1") int current,
