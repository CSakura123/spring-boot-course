...
class UserAccountMapperTest {
    ...
    void testSelectId() {
        ...
        assertEquals(userAccountMapper.insert(userAccount),1);
    }
    @Test
    ...
    void testInsert() {
        UserAccount userAccount = new UserAccount();
        userAccount.setUsername("syy");
        userAccount.setNickname("SYY");
        userAccount.setEmail("3068195512@qq.com");
        userAccount.setPhone("15555555555");
